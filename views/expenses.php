...
$top_cat = $top_cat ? $top_cat : __( 'None Recorded', 'ozone-skypool' );
...
<div class="ifs-pms-expense-wrapper">
    ...
    <div class="ifs-pms-kpi-grid">
        <div class="ifs-pms-kpi-card">
            <div class="ifs-pms-kpi-top">
                <span class="ifs-pms-kpi-label"><?php esc_html_e( 'Selected Range Cost', 'ozone-skypool' ); ?></span>
            ...
            <div class="ifs-pms-kpi-sub"><?php printf( esc_html__( 'Filtered total (%s to %s)', 'ozone-skypool' ), esc_html( $start_date_input ), esc_html( $end_date_input ) ); ?></div>
        </div>

        <div class="ifs-pms-kpi-card">
            <div class="ifs-pms-kpi-top">
                <span class="ifs-pms-kpi-label"><?php esc_html_e( 'Today\'s Outflow', 'ozone-skypool' ); ?></span>
            ...
            <div class="ifs-pms-kpi-sub"><?php esc_html_e( 'Disbursements posted today', 'ozone-skypool' ); ?></div>
        </div>

        <div class="ifs-pms-kpi-card">
            <div class="ifs-pms-kpi-top">
                <span class="ifs-pms-kpi-label"><?php esc_html_e( 'Major Cost Sector', 'ozone-skypool' ); ?></span>
            ...
            <div class="ifs-pms-kpi-sub"><?php esc_html_e( 'Highest allocation in range', 'ozone-skypool' ); ?></div>
        </div>
    </div>
    ...
    <div class="ifs-pms-subnav-bar" role="tablist">
        ...
        <button type="button" class="ifs-pms-subnav-btn <?php echo ( $active_tab === 'list' ) ? 'active' : ''; ?>" onclick="ifsPms.switchExpenseTab('list', this)">
            <i class="fa-solid fa-receipt"></i> <?php esc_html_e( 'All Expenses & Audit', 'ozone-skypool' ); ?>
        </button>
    </div>
            ...
            <div class="ifs-pms-panel-card">
                <div class="ifs-pms-panel-head">
                    <h3 class="ifs-pms-panel-title">
                        <i class="fa-solid fa-circle-plus" style="color: #0284c7;"></i>
                ...
                <form method="POST" action="<?php echo esc_url( $base_url . '&view=expenses' ); ?>" id="ifsPmsExpenseForm">
                    ...
                    <div class="ifs-pms-form-stack">
                        <div class="ifs-pms-form-group">
                            <label class="ifs-pms-label" for="ifsExpTitle"><?php esc_html_e( 'Outflow Purpose / Description', 'ozone-skypool' ); ?> *</label>
                            <input type="text" name="expense_title" id="ifsExpTitle" required placeholder="<?php esc_attr_e( 'e.g. Monthly Staff Salary / Electricity Bill', 'ozone-skypool' ); ?>" autocomplete="off">
                            <div class="ifs-pms-chips-wrap">
                                <span class="ifs-pms-chip" onclick="ifsPms.setExpensePreset('Monthly Staff Salary & Wages', 'Staff Salaries')"><?php esc_html_e( 'Staff Salary', 'ozone-skypool' ); ?></span>
                                <span class="ifs-pms-chip" onclick="ifsPms.setExpensePreset('Monthly Electricity & Power Utility Bill', 'Utility Bills')"><?php esc_html_e( 'Utility Bill', 'ozone-skypool' ); ?></span>
                                <span class="ifs-pms-chip" onclick="ifsPms.setExpensePreset('Liquid Chlorine 50L Drum', 'Water Treatment')"><?php esc_html_e( 'Chlorine Drum', 'ozone-skypool' ); ?></span>
                                <span class="ifs-pms-chip" onclick="ifsPms.setExpensePreset('Rooftop BBQ Charcoal & Fuel', 'Restaurant & F&B')"><?php esc_html_e( 'BBQ Charcoal', 'ozone-skypool' ); ?></span>
                                <span class="ifs-pms-chip" onclick="ifsPms.setExpensePreset('Tower Backup Generator Diesel', 'Electricity / Utilities')"><?php esc_html_e( 'Diesel Gen', 'ozone-skypool' ); ?></span>
                                <span class="ifs-pms-chip" onclick="ifsPms.setExpensePreset('Pool Vacuum Filter Cartridge', 'Pump Maintenance')"><?php esc_html_e( 'Filter Cartridge', 'ozone-skypool' ); ?></span>
                            </div>
                        </div>

                        <div class="ifs-pms-form-group">
                            <label class="ifs-pms-label" for="ifsExpCat"><?php esc_html_e( 'Operational Sector', 'ozone-skypool' ); ?> *</label>
                            <select name="expense_cat" id="ifsExpCat">
                                <option value="Staff Salaries"><?php esc_html_e( 'Staff Salaries & Wages', 'ozone-skypool' ); ?></option>
                                <option value="Utility Bills"><?php esc_html_e( 'Utility Bills (Electricity, Water, Gas)', 'ozone-skypool' ); ?></option>
                                ...
                                <option value="Electricity / Utilities"><?php esc_html_e( 'General Utilities & Power', 'ozone-skypool' ); ?></option>
                                <option value="Pump Maintenance"><?php esc_html_e( 'Pump, Filter & Mechanical Maintenance', 'ozone-skypool' ); ?></option>
                                <option value="Staff Expenses"><?php esc_html_e( 'Staff Uniforms, Meals & Bonus', 'ozone-skypool' ); ?></option>
                        ...
                        <div class="ifs-pms-grid-2">
                            <div class="ifs-pms-form-group">
                                <label class="ifs-pms-label" for="ifsExpAmount"><?php printf( esc_html__( 'Amount Outflow (%s)', 'ozone-skypool' ), esc_html( $currency ) ); ?> *</label>
                                <input type="number" step="0.01" name="expense_amount" id="ifsExpAmount" class="ifs-pms-mono" required placeholder="0.00" min="0.01">
                            </div>

                            <div class="ifs-pms-form-group">
                                <label class="ifs-pms-label" for="ifsExpDate"><?php esc_html_e( 'Disbursement Date', 'ozone-skypool' ); ?> *</label>
    ...
    <div id="ifsPmsExpensePaneList" class="ifs-pms-tab-pane <?php echo ( $active_tab === 'list' ) ? 'active' : ''; ?>">
        <div class="ifs-pms-panel-card">
            <div class="ifs-pms-panel-head">
                <h3 class="ifs-pms-panel-title">
                    <i class="fa-solid fa-receipt" style="color: #475569;"></i>
                    <?php esc_html_e( 'Expense Audit & Date Range Registry', 'ozone-skypool' ); ?>
                </h3>
                <span class="ifs-pms-badge" style="background: #f1f5f9; color: #475569; border: 1px solid #cbd5e1; font-weight: 700; padding: 6px 12px; border-radius: 8px;">
                    <?php echo count( $expenses ); ?> <?php esc_html_e( 'Postings Found', 'ozone-skypool' ); ?>
                </span>
            </div>

            <!-- Date Range & Sector Filtering Toolbar -->
            <div class="ifs-pms-audit-toolbar">
                <form method="GET" action="<?php echo esc_url( admin_url( 'admin.php' ) ); ?>" style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap; margin: 0; width: 100%;">
                    ...
                    <div class="ifs-pms-audit-filters">
                        <div class="ifs-pms-date-pill">
                            <span style="font-size: 11px; font-weight: 700; color: #64748b;"><?php esc_html_e( 'From', 'ozone-skypool' ); ?></span>
                            <input type="date" name="start_date" value="<?php echo esc_attr( $start_date_input ); ?>">
                            <span style="font-size: 11px; font-weight: 700; color: #64748b;"><?php esc_html_e( 'To', 'ozone-skypool' ); ?></span>
                            <input type="date" name="end_date" value="<?php echo esc_attr( $end_date_input ); ?>">
                        </div>

                        <select name="sector" onchange="this.form.submit()">
                            <option value="ALL" <?php selected( $sector_filter, 'ALL' ); ?>><?php esc_html_e( 'All Sectors', 'ozone-skypool' ); ?></option>
                            <option value="Staff Salaries" <?php selected( $sector_filter, 'Staff Salaries' ); ?>><?php esc_html_e( 'Staff Salaries', 'ozone-skypool' ); ?></option>
                            <option value="Utility Bills" <?php selected( $sector_filter, 'Utility Bills' ); ?>><?php esc_html_e( 'Utility Bills', 'ozone-skypool' ); ?></option>
                            <option value="Water Treatment" <?php selected( $sector_filter, 'Water Treatment' ); ?>><?php esc_html_e( 'Water Treatment', 'ozone-skypool' ); ?></option>
                            <option value="Restaurant & F&B" <?php selected( $sector_filter, 'Restaurant & F&B' ); ?>><?php esc_html_e( 'Restaurant & F&B', 'ozone-skypool' ); ?></option>
                            <option value="Electricity / Utilities" <?php selected( $sector_filter, 'Electricity / Utilities' ); ?>><?php esc_html_e( 'General Utilities', 'ozone-skypool' ); ?></option>
                            <option value="Pump Maintenance" <?php selected( $sector_filter, 'Pump Maintenance' ); ?>><?php esc_html_e( 'Pump Maintenance', 'ozone-skypool' ); ?></option>
                            <option value="Staff Expenses" <?php selected( $sector_filter, 'Staff Expenses' ); ?>><?php esc_html_e( 'Staff Meals / Uniforms', 'ozone-skypool' ); ?></option>
                            <option value="General Facility" <?php selected( $sector_filter, 'General Facility' ); ?>><?php esc_html_e( 'General Facility', 'ozone-skypool' ); ?></option>
                            <option value="Other Costs" <?php selected( $sector_filter, 'Other Costs' ); ?>><?php esc_html_e( 'Other Costs', 'ozone-skypool' ); ?></option>
                        </select>
                    </div>

                    <div class="ifs-pms-flex-gap-8">
                        <button type="submit" class="ifs-pms-btn ifs-pms-btn-sm" style="background: #0284c7; color: #fff; height: 46px !important; padding: 0 20px !important; border-radius: 12px;">
                            <i class="fa-solid fa-filter"></i> <?php esc_html_e( 'Filter Ledger', 'ozone-skypool' ); ?>
                        </button>
                        <button type="button" class="ifs-pms-btn ifs-pms-btn-sm" style="background: #f1f5f9; color: #475569; border: 1.5px solid #cbd5e1; height: 46px !important; padding: 0 16px !important; border-radius: 12px;" onclick="window.print()">
                        ...
                        <?php if ( ! empty( $expenses ) ) : ?>
                            <?php foreach ( $expenses as $e ) : ?>
                                <tr class="ifs-pms-expense-data-row" data-cat="<?php echo esc_attr( $e->category ); ?>">
                                    ...
                                    <td style="color: #ef4444; font-weight: 800;" class="ifs-pms-mono">
                                    ...
                                    <td style="text-align: right; white-space: nowrap;">
                                        ...
                                        <?php if ( $is_admin ) : ?>
                                            <form method="POST" action="<?php echo esc_url( $base_url . '&view=expenses' ); ?>" style="display: inline-block; margin: 0;" onsubmit="return confirm(<?php echo wp_json_encode( __( 'Delete this expense posting permanently?', 'ozone-skypool' ) ); ?>);">
                                                ...
                                                <button type="submit" class="ifs-pms-btn ifs-pms-btn-sm ifs-pms-btn-delete" title="<?php esc_attr_e( 'Delete Permanently', 'ozone-skypool' ); ?>">
                        ...
                        <?php else : ?>
                            <tr id="ifsPmsExpenseEmptyRow">
                                <td colspan="6" style="text-align: center; padding: 56px 16px; color: #94a3b8;">
                                    ...
                                    <?php esc_html_e( 'No operational expenditures recorded for this date range.', 'ozone-skypool' ); ?>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
            ...
            <div class="ifs-pms-table-footer">
                <span style="font-weight: 700; color: #0f172a;"><?php esc_html_e( 'Total Filtered Outflow Outlay', 'ozone-skypool' ); ?></span>
                <strong class="ifs-pms-mono" style="color: #ef4444; font-size: 18px;">
    ...
    <div class="ifs-pms-modal-card">
        ...
        <div class="ifs-pms-modal-details-stack">
            <div class="ifs-pms-modal-row">
                <span class="ifs-pms-modal-label"><?php esc_html_e( 'Description:', 'ozone-skypool' ); ?></span>
                <strong class="ifs-pms-modal-val-strong" id="ifsPmsViewExpTitle">--</strong>
            </div>

            <div class="ifs-pms-modal-row">
                <span class="ifs-pms-modal-label"><?php esc_html_e( 'Sector Category:', 'ozone-skypool' ); ?></span>
                <span class="ifs-pms-cat-badge" id="ifsPmsViewExpCat">--</span>
            </div>

            <div class="ifs-pms-modal-row">
                <span class="ifs-pms-modal-label"><?php esc_html_e( 'Amount Outflow:', 'ozone-skypool' ); ?></span>
                <strong class="ifs-pms-mono ifs-pms-modal-val-red" id="ifsPmsViewExpAmount">--</strong>
            </div>

            <div class="ifs-pms-modal-row">
                <span class="ifs-pms-modal-label"><?php esc_html_e( 'Payment Date:', 'ozone-skypool' ); ?></span>
                <span class="ifs-pms-mono" id="ifsPmsViewExpDate">--</span>
            </div>

            <div class="ifs-pms-modal-row-last">
                <span class="ifs-pms-modal-label"><?php esc_html_e( 'Logged By Operator:', 'ozone-skypool' ); ?></span>
                <span class="ifs-pms-modal-val-muted" id="ifsPmsViewExpBy">--</span>
            </div>
        </div>

        <div style="margin-top: 28px;">
            <button type="button" class="ifs-pms-btn ifs-pms-btn-sm" style="width: 100%; height: 48px; border-radius: 12px; background: #f1f5f9; color: #475569; border: 1.5px solid #cbd5e1;" onclick="ifsPms.closeViewExpenseModal()">
    ...
    <div class="ifs-pms-modal-card">
        ...
        <form method="POST" action="<?php echo esc_url( $base_url . '&view=expenses' ); ?>" id="ifsPmsEditExpenseForm">
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
                <div class="ifs-pms-form-group">
                    <label class="ifs-pms-label"><?php esc_html_e( 'Outflow Description', 'ozone-skypool' ); ?> *</label>
                    <input type="text" name="expense_title" id="ifsPmsEditExpTitle" required>
                </div>

                <div class="ifs-pms-form-group">
                    <label class="ifs-pms-label"><?php esc_html_e( 'Operational Sector', 'ozone-skypool' ); ?> *</label>
                ...
                <div class="ifs-pms-grid-2">
                    <div class="ifs-pms-form-group">
                        <label class="ifs-pms-label"><?php printf( esc_html__( 'Amount (%s)', 'ozone-skypool' ), esc_html( $currency ) ); ?> *</label>
                        <input type="number" step="0.01" name="expense_amount" id="ifsPmsEditExpAmount" class="ifs-pms-mono" required min="0.01">
                    </div>

                    <div class="ifs-pms-form-group">
                        <label class="ifs-pms-label"><?php esc_html_e( 'Date', 'ozone-skypool' ); ?> *</label>
                ...
                <div class="ifs-pms-flex-gap-14">
                    ...
                    <button type="button" class="ifs-pms-btn ifs-pms-btn-sm" style="flex: 1; height: 50px; border-radius: 14px; font-weight: 700; background: #f1f5f9; color: #475569; border: 1.5px solid #cbd5e1;" onclick="ifsPms.closeEditExpenseModal()">
